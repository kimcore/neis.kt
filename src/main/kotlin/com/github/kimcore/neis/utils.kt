...
fun startOfWeek(): LocalDate = LocalDate.ofInstant((calendar.clone() as Calendar).apply {
    set(Calendar.DAY_OF_WEEK, calendar.firstDayOfWeek)
}.time.toInstant(), zone)

fun endOfWeek(): LocalDate = LocalDate.ofInstant((calendar.clone() as Calendar).apply {
